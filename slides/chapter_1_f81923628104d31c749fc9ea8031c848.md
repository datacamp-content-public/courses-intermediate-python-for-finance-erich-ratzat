...
`@script`
We know that the daily return is calculated by the formula : price of today divided by price of yesterday. And what about the annual return? The logic is the same, however we will have as price of today the last price of the year and for yesterday price the first price of the year.
